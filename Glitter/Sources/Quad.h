...
{
public:
    Quad(std::string _name, Shader _shader)
    {
        name.assign(_name);
        shader = _shader;
        InitRenderData();
    ...
    void Draw(GLuint texture, glm::vec3 position, glm::vec3 scale = glm::vec3(1.0f, 1.0f, 1.0f), glm::vec3 rotate = glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3 color = glm::vec3(1.0f))
    {
        this->shader.use();
