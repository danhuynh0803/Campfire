...
void VulkanImGui::DrawFrame(vk::CommandBuffer cmdBuffer)
{
    ...
    //renderPassBeginInfo.renderPass = VulkanContext::Get()->GetGraphicsPipeline()->GetVulkanRenderPass();
...
void VulkanImGui::InitResources()
{
    ...
    pipelineCreateInfo.renderPass = VulkanContext::Get()->GetGraphicsPipeline()->mRenderPass.get();
